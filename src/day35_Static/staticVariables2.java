...
public class staticVariables2 {
    ...
    static int staticVariable; //tehre is only one copy of static shared by all objects
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(staticVariables2.insVariable); // instance CANNOT called
    }
