...
public class BankAccount {
    ...
    public void setAccountHolder(String firstName, String lastName){ accountHolder=firstName+" "+lastName; }
    ...
    public void depositing(int amount){balance+=amount; }

    public void withdrawing(int amount){setBalance(balance-amount);}
    ...
    public String toString(){
        return "Full Name: "+getAccountHolder()+", Balance: "+balance;
    }
